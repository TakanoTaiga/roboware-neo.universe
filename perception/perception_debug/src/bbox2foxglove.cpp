...
{
  void add_points(foxglove_msgs::msg::PointsAnnotation &input_annotation, const uint16_t &x, const uint16_t &y){
  ...
  foxglove_msgs::msg::Color rgba2color(const double &r, const double &g, const double &b, const double &a){
...
namespace perception_debug
{
    ...
    {   
      pub_foxglove_2d_bbox_ = create_publisher<foxglove_msgs::msg::ImageAnnotations>(
        "output/image_annotation", 0);
      sub_yolox_ex_2d_bbox_ = create_subscription<bboxes_ex_msgs::msg::BoundingBoxes>(
        "input/image_annotation", 0, std::bind(&bbox2foxgloveNode::subscriber_callback, this, std::placeholders::_1));
    }
