...
{
  Matrix3x3(
    float m11_, float m12_, float m13_, float m21_, float m22_, float m23_, float m31_, float m32_,
    float m33_)
  : m11(m11_),
    m12(m12_),
    m13(m13_),
...
struct Matrix2x3
{
  ...
  : m11(m11_), m12(m12_), m13(m13_), m21(m21_), m22(m22_), m23(m23_)
  {
  }
...
{
  return Matrix3x3(
    matrix.m11, matrix.m21, matrix.m31, matrix.m12, matrix.m22, matrix.m23, matrix.m13, matrix.m23,
    matrix.m33);
}

Matrix2x2 transpose_2x2(Matrix2x2 matrix)
{
  return Matrix2x2(matrix.m11, matrix.m21, matrix.m12, matrix.m22);
}

Matrix2x3 transpose_3x2(Matrix3x2 matrix)
{
  return Matrix2x3(matrix.m11, matrix.m21, matrix.m31, matrix.m12, matrix.m22, matrix.m32);
}

Matrix3x2 transpose_2x3(Matrix2x3 matrix)
{
  return Matrix3x2(matrix.m11, matrix.m21, matrix.m12, matrix.m22, matrix.m13, matrix.m23);
}
...
Matrix2x2 inverse_2x2(Matrix2x2 matrix)
{
  ...
  return Matrix2x2(
    matrix.m22 * coef, -1.0 * matrix.m21 * coef, -1.0 * matrix.m12 * coef, matrix.m11 * coef);
}
...
float det_2x2(Matrix2x2 matrix) { return (matrix.m11 * matrix.m22 - matrix.m12 * matrix.m21); }
...
Matrix3x3 inverse_3x3(Matrix3x3 matrix)
{
  ...
  auto t_coaf = transpose_3x3(coaf);

  return Matrix3x3(
    coaf.m11 / det_, coaf.m12 / det_, coaf.m13 / det_, coaf.m21 / det_, coaf.m22 / det_,
    coaf.m23 / det_, coaf.m31 / det_, coaf.m32 / det_, coaf.m33 / det_);
}
...
Matrix3x3 multiply(Matrix3x3 a, Matrix3x3 b)
{
  return Matrix3x3(
    ...
    a.m11 * b.m13 + a.m12 * b.m23 + a.m13 * b.m33, a.m21 * b.m11 + a.m22 * b.m21 + a.m23 * b.m31,
    a.m21 * b.m12 + a.m22 * b.m22 + a.m23 * b.m32, a.m21 * b.m13 + a.m22 * b.m23 + a.m23 * b.m33,
...
{
  return Vector2(a.m11 * b.x + a.m12 * b.y + a.m13 * b.z, a.m21 * b.x + a.m22 * b.y + a.m23 * b.z);
}
...
{
  return Vector3(a.m11 * b.x + a.m12 * b.y, a.m21 * b.x + a.m22 * b.y, a.m31 * b.x + a.m32 * b.y);
}

Matrix3x2 multiply(Matrix3x2 a, Matrix2x2 b)
{
  return Matrix3x2(
    a.m11 * b.m11 + a.m12 * b.m21, a.m11 * b.m12 + a.m12 * b.m22, a.m21 * b.m11 + a.m22 * b.m21,
    a.m21 * b.m12 + a.m22 * b.m22, a.m31 * b.m11 + a.m32 * b.m21, a.m31 * b.m12 + a.m32 * b.m22);
}
...
{
  return Vector3(
    a.m11 * b.x + a.m12 * b.y + a.m13 * b.z, a.m21 * b.x + a.m22 * b.y + a.m23 * b.z,
    a.m31 * b.x + a.m32 * b.y + a.m33 * b.z);
}

Matrix2x2 to_2x2(Matrix3x3 matrix)
{
  return Matrix2x2(matrix.m11, matrix.m12, matrix.m21, matrix.m22);
}

Matrix2x2 add(Matrix2x2 a, Matrix2x2 b)
{
  return Matrix2x2(a.m11 + b.m11, a.m12 + b.m12, a.m21 + b.m21, a.m22 + b.m22);
}
...
Vector3 substract(Vector3 a, Vector3 b) { return Vector3(a.x - b.x, a.y - b.y, a.z - b.z); }
...
Matrix3x3 rotation_from_euler(Vector3 euler)
{
  ...
  return Matrix3x3(
    cos_y * cos_z, -1.0 * cos_y * sin_z, sin_y, sin_x * sin_y * cos_z + cos_x * sin_z,
    -1.0 * sin_x * sin_y * sin_z + cos_x * cos_z, -1.0 * sin_x * cos_y,
    -1.0 * cos_x * sin_y * cos_z + sin_x * sin_z, cos_x * sin_y * sin_z + sin_x * cos_z,
    cos_x * cos_y);
}
}  // namespace motiodom
